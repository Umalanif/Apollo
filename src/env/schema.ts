...
const EnvSchema = z.object({
  ...
  PROXY_STICKY_PORT: z.coerce.number().int().min(1).max(65535).default(10000),
  PROXY_SESSION_KEY: z.string().min(1).default('apollo-main'),
  PROXY_SESSION_TTL_MINUTES: z.coerce.number().int().min(1).max(1440).default(120),
